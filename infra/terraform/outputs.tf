...
output "aws_lambda_hellokittyfarhanahmed_function_arn" {
  value = module.appcd_00a20b0a-2ec0-5bdc-a08d-65a85dc81d5b.function_arn
  sensitive = false
}


output "aws_lambda_hellokittyfarhanahmed_function_name" {
  value = module.appcd_00a20b0a-2ec0-5bdc-a08d-65a85dc81d5b.function_name
  sensitive = false
}


output "aws_lambda_hellokittyfarhanahmed_function_url" {
  value = module.appcd_00a20b0a-2ec0-5bdc-a08d-65a85dc81d5b.function_url
  sensitive = false
}


output "aws_lambda_hellokittyfarhanahmed_invoke_arn" {
